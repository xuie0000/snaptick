			...
			DefaultWheelDatePicker(
				...
				onSnappedDate = { snappedDate ->
					val newDateTime = when (snappedDate) {
						is SnappedDate.DayOfMonth -> snappedDateTime.withDayOfMonth(snappedDate.snappedLocalDate.dayOfMonth)
						is SnappedDate.Month -> snappedDateTime.withMonth(snappedDate.snappedLocalDate.monthValue)
